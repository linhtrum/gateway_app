...
import { Icons, Button, Card, CardModal } from "../Components.js";
...
function Home() {
  ...
  const handleDeleteCard = (cardIndex) => {
    if (confirm(`Are you sure you want to delete this card ${displayCards[cardIndex].t}?`)) {
  ...
  return html`
    <div class="p-6">
      ...
      <${CardModal}
        ...
        card=${editingCardIndex !== null ? displayCards[editingCardIndex] : null}
